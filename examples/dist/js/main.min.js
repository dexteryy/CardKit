...
return te&&ee&&(F=!0),o.prototype={isPlaying:function(){return F?!!this._runningActors.state:i.isRunning(this.name)},isCompleted:function(){return 0>=this._count},play:function(){return this.isCompleted()&&(clearTimeout(this._end_timer),this._reset_promise.fire(),this._optCache.forEach(function(t){this.actor(t)},this)),F?this.isPlaying()||(this._runningActors.state=1,this._runningActors.forEach(h)):i.run(this.name),this},pause:function(){return F?(this._runningActors.state=0,this._runningActors.forEach(l)):i.pause(this.name),this},clear:function(){return this.cancel(),this._optCache.forEach(function(t){t._cached=!1}),this._optCache.length=0,this},cancel:function(){return c(this,function(t,e){F?l(e):i.remove(t)}),this._optCache.forEach(function(t){t._promise.reject([{target:t.target,succ:!1}]).disable()}),this},complete:function(){return c(this,function(t,e){F?(u(e),e._promise.resolve([{target:e.target,succ:!0}]).disable()):i.complete(t)}),this},actor:function(t,n){function i(t){(t||l.follow()).reset().enable()}function a(t){return t.follow().bind(o),t._opt._watcher=o,delete t._opt._parent,t}function o(t){--p._count>0||(p._end_timer=setTimeout(function(){c(p),p._promise[t.succ?"resolve":"reject"]([{succ:t.succ}])},0))}var l,u,p=this,m=this.name;if(clearTimeout(this._end_timer),n){if(t.nodeType){var v,g={};if(R.forEach(function(t,e){"prop"===t?v=this[e]:"to"!==t&&(g[t]=this[e])},arguments),u=Object.keys(v).map(function(t){return p.actor(e.mix({_parent:!0,prop:t,to:v[t]},this))},g),1===u.length)return u[0]}else u=V.call(arguments),u=u.map(function(t){return t._parent=!0,p.actor(t)});return this._reset_promise.bind(i),l=new s(u,p)}if(t.prop=U[t.prop]||t.prop,t._promise&&i(t._promise),t.prop===J){var _=x(t.target);return u=f(t.to,function(n){return e.merge(n,t),n._parent=!0,n._promise=_,p.actor(n)}),this._reset_promise.bind(i),l=new s(u,p)}return p._count++,t._promise||(t._promise=new r.Promise),F?(this._runningActors.push(t),this.isPlaying()&&h(t)):d(m,t),l=new s(t,p),t._cached||(t._cached=!0,this._optCache.push(t),a(l)),l},group:function(){var t,e=this,n=V.call(arguments).filter(function(t){return t.stage===e});return this._reset_promise.bind(function(){t.follow().reset().enable()}),t=new s(n,e)},follow:function(){return this._promise}},s.prototype={enter:function(t){this.stage&&this.exit();var n=t.actor.apply(t,[].concat(T(this)));return n.follow().merge(this.follow()),e.mix(this,n)},exit:function(){var t=this.stage,n=this._opt;if(!t)return this;this.members?this.members=this.members.map(function(t){return t.exit()}):(F?(C(t._runningActors,n),t.isPlaying()&&l(n)):i.remove(t.name,n._render),C(t._optCache,n),n._promise.reject([{target:n.target,succ:!1}]).disable());var r=this.fork();return n._parent||r.follow().merge(n._promise),e.occupy(n,r._opt),delete this.stage,this},fork:function(){if(this.members)return new s(this.members.map(function(t){return t.fork()}));var t={};return R.forEach(function(e){t[e]=this[e]},this._opt),t._promise=new r.Promise,new s(t)},setto:function(t){return O(this,t,function(t,e){return e||0===e?e:t.to})},extendto:function(t){return O(this,t,function(t,e){if(!e)return t.to;var n=w(t.to,e);return parseFloat(t.to)+parseFloat(e)+n})},reverse:function(){return O(this,{},function(t){return void 0!==t.from?t.from:t._current_from})},follow:function(){return this._opt._promise}},e.mix(S,{VERSION:"1.0.3",renderMode:F?"css":"js",Stage:o,Actor:s,config:function(t){t.easing&&(e.mix(G,t.easing.values),e.mix(Q,t.easing.functions),i&&i.config({easing:Q})),/(js|css)/.test(t.renderMode)&&(F="css"===t.renderMode,this.renderMode=t.renderMode)},transform:k}),S}),define("soviet",["mo/lang/es5","mo/lang/mix","mo/lang/type","mo/lang/struct","dollar"],function(t,e,n,i,r){function a(t,n){e.config(this,n||{},m),this.target=r(t),this.events={},this.locks={},this.traceStack||(this.traceStack=[])}function o(t,e,n){var i;return t&&(this.trace&&(this.traceStack.unshift("<"+e.nodeName+"#"+(e.id||"")+">."+(e.className||"").split(/\s+/).join(".")),this.traceStack.length>this.trace&&this.traceStack.pop()),i=t.call(e,n),this.preventDefault&&!i&&n.preventDefault()),i}function s(t,e,n,i){var r=t[e];i?t[e]=n:n&&(r||(r=t[e]=d()),r.push(n))}function c(t,e,n,i){var r=t[e];!n||i?delete t[e]:r&&r.clear(n)}function l(t,e){return t[e]}function u(t){return this.locks[t]=this.matchesSelector?{}:{".":{},"#":{},"&":{}}}function h(t,e,n,i,r){if(void 0===r&&(r=this.autoOverride),e){if(!this.matchesSelector){var a=(/^[\.#]/.exec(e)||["&"])[0];e=e.substr("&"!==a?1:0),t=t[a],"."===a&&(e=e.split(".").join(" "))}}else e="_self_";return i(t,e,n,r)}var d=i.fnQueue,f=n.isFunction,p=r.find.matchesSelector,m={preventDefault:!1,matchesSelector:!1,autoOverride:!1,aliasEvents:{},trace:!1,traceStack:null};a.prototype={on:function(t,e,n){if(f(e)&&(n=e,e=void 0),"object"==typeof e)for(var i in e)this.on(t,i,e[i]);else{t=this.aliasEvents[t]||t;var r=this.events[t];r||(this.target.bind(t,this.trigger.bind(this)),this.reset(t),r=this.events[t]),h.call(this,r,e,n,s)}return this},off:function(t,e,n){f(e)&&(n=e,e=void 0),t=this.aliasEvents[t]||t;var i=this.events[t];return i&&h.call(this,i,e,n,c),this},matches:function(t,e){t=this.aliasEvents[t]||t;var n=this.events[t];return h.call(this,n,e,null,l)},reset:function(t){return t?(t=this.aliasEvents[t]||t,this.events[t]=this.matchesSelector?{}:{".":{},"#":{},"&":{}},u.call(this,t)):(this.events={},this.locks={}),this},disable:function(t,e){var n=this.locks;if(t){t=this.aliasEvents[t]||t;var i=n[t];i||(i=u.call(this,t)),e?h.call(this,i,e,!0,s,!0):i._disable=!0}else this._global_lock=!0;return this},enable:function(t,e){var n=this.locks;if(t){t=this.aliasEvents[t]||t;var i=n[t];i&&(e?h.call(this,i,e,null,c,!0):delete i._disable)}else delete this._global_lock;return this},trigger:function(t){var e=this.aliasEvents[t.type];e&&(t.type=e);var n,i=this,r=t.target,a=this.locks[t.type]||{},s=this.events[t.type];if(!s||this._global_lock||a._disable)return n;if(this.matchesSelector)Object.keys(s).forEach(function(e){!a[e]&&p(this,e)&&(n=o.call(i,s[e],this,t))},r);else{var c,l,u=(c="#")&&(l=r.id)&&s[c][l]||(c=".")&&(l=r.className)&&s[c][l]||(c="&")&&(l=r.nodeName.toLowerCase())&&s[c][l]||null;if(u){var h=a[c][l];h||(n=o.call(this,u,r,t))}}return s._self_&&(n=o.call(this,s._self_,r,t)),n}};var v=function(t,e){return new v.Soviet(t,e)};return v.Soviet=a,v}),define("mo/easing/timing",["mo/lang/mix","mo/easing/base"],function(t,e){function n(t,e){e=e||{};for(var n in t)e[n]="cubic-bezier("+t[n].join(",")+")";return e}var i={easeInQuad:[.55,.085,.68,.53],easeInCubic:[.55,.055,.675,.19],easeInQuart:[.895,.03,.685,.22],easeInQuint:[.755,.05,.855,.06],easeInSine:[.47,0,.745,.715],easeInExpo:[.95,.05,.795,.035],easeInCirc:[.6,.04,.98,.335],easeInBack:[.6,-.28,.735,.045],easeOutQuad:[.25,.46,.45,.94],easeOutCubic:[.215,.61,.355,1],easeOutQuart:[.165,.84,.44,1],easeOutQuint:[.23,1,.32,1],easeOutSine:[.39,.575,.565,1],easeOutExpo:[.19,1,.22,1],easeOutCirc:[.075,.82,.165,1],easeOutBack:[.175,.885,.32,1.275],easeInOutQuad:[.455,.03,.515,.955],easeInOutCubic:[.645,.045,.355,1],easeInOutQuart:[.77,0,.175,1],easeInOutQuint:[.86,0,.07,1],easeInOutSine:[.445,.05,.55,.95],easeInOutExpo:[1,0,0,1],easeInOutCirc:[.785,.135,.15,.86],easeInOutBack:[.68,-.55,.265,1.55]};return i.swing=i.jswing=e.positions.ease,{positions:t.mix(i,e.positions),values:t.mix(n(i),e.values),stringify:n}}),define("../cardkit/app",["dollar","mo/lang","mo/browsers","mo/template","mo/easing/timing","soviet","choreo","momo/base","momo/tap","momo/swipe","momo/drag","momo/scroll","../cardkit/view/control","../cardkit/view/picker","../cardkit/view/stars","../cardkit/view/modalcard","../cardkit/view/actionview","../cardkit/view/growl","../cardkit/tpl/layout/overflowmenu","../cardkit/tpl/layout/ctlbar","../cardkit/bus","../cardkit/render","../cardkit/supports","cardkit/env","mo/domready"],function(t,e,n,i,r,a,o,s,c,l,u,h,d,f,p,m,v,g,_,k,b,w,y,C){function x(){pe.openModal(t(this).data())}function T(){var t=d(this),e=t.data();e.disableUrl||e.disableJsonUrl?t.toggle():t.isEnabled||t.enable()}function O(){var t=d(this).toggle();j(t)}function S(){return t(this).hasClass("ck-post-button")?(T.call(this),void 0):S.call(this.parentNode)}function E(){return t(this).hasClass("ck-switch")?(O.call(this),void 0):E.call(this.parentNode)}function L(n){var i=e.mix({confirmText:"确认",cancelText:"取消",multiselect:!1},n.data());return i.options=t(i.options||".ck-option",n),v(n,i).open()}function A(t,e){var n=p(this),i=n.calc(t);n[e](i)}function j(t){t.parentId||(t.parentId=++ee),pe.viewportGarbage[t.parentId]=1}function H(){}function D(e){var n=t(this).closest(".ck-list-wrap"),i=n.data("ckSlideAnime");i||(i=n.data("ckSlideAnime",+new Date));var r=pe.slideItemWidth,a=n[0].scrollLeft,s=a/r,c=s-Math.floor(s),l=t(".ck-list",n)[0],u=t(".ck-item",l).length-1;if(s>0&&u>s&&u-s>.1){s=e?.1>c?Math.floor(s):Math.ceil(s):c>.9?Math.ceil(s):Math.floor(s);var h=a-s*r+(s===u?le:0);n.addClass("stop-scroll"),o(i).clear().play().actor(l,{transform:"translateX("+h+"px)"},200,"easeOutSine").follow().then(function(){o.transform(l,"translateX","0"),n[0].scrollLeft-=h,n.removeClass("stop-scroll")})}}function R(t){return t.replace(/#.*/,"")===J.href.replace(/#.*/,"")}function M(e){var n,i,r=e.replace(/#(.*)/,function(t,e){return n=e,""}),a=J.href.replace(/#(.*)/,function(t,e){return i=e||"",""});if(n&&r===a){if(!(n&&t("#"+n).hasClass("ck-card")&&n!==pe.viewport[0].id||(n=ae,i.split(ie).pop()!==n)))return!1}else n="";return n}function N(e){for(var n=e.target;!n.href;)n=n.parentNode;var i=M(n.href);if(i!==!1){if(t(n).hasClass("ck-link-extern"))return W(n.href,{target:"_blank"}),void 0;if(t(n).hasClass("ck-link-direct"))return i?I(i,null,!0):W(n.href),void 0;if(t(n).hasClass("ck-link"));else{if(/(^|\s)ck-\w+/.test(n.className))return;if(n.target)return i&&"_self"===n.target?I(i,null,!0):W(n.href,n),void 0}i?I(i):I(oe,n.href)}}function I(e,n,i){if(pe.disableControl(),m.isOpened)return pe.closeModal().done(function(){I(e,n)}),void 0;if(pe._navDrawerLastView)return pe.closeNavDrawer().then(function(){I(e,n)}),void 0;pe._sessionLocked=!0;var r=e&&t("#"+e);if(!r.hasClass("ck-card")||e===pe.viewport[0].id)return pe.enableControl(),pe._sessionLocked=!1,void 0;pe.hideTopbar();var a=pe.viewport;if(P(e),i)return pe.loadingCard.addClass("moving").show(),setTimeout(function(){pe.changeView(r),a.hide(),pe.loadingCard.hide().removeClass("moving"),pe.enableControl(),pe._sessionLocked=!1,pe.showTopbar()},400),void 0;o.transform(r[0],"translateX",$.innerWidth+"px"),r.addClass("moving"),pe.changeView(r),pe.cardMask.css("opacity",0).addClass("moving");var s=o("card:moving").clear().play();s.actor(pe.cardMask[0],{opacity:"0.8"},400,"ease"),s.actor(r[0],{transform:"translateX(0)"},450,"ease"),s.follow().then(function(){a.hide(),pe.cardMask.removeClass("moving").css("opacity",0),r.removeClass("moving"),n?(pe._unexpectStateWhenGoback=!1,pe._pageCached=!0,$.location=n):(pe.enableControl(),pe._sessionLocked=!1,pe.showTopbar())})}function V(e){if(pe._sessionLocked=!0,pe.disableControl(),pe._navDrawerLastView)return pe.closeNavDrawer().then(function(){V(e)}),void 0;if(v.current)return v.current.close().event.once("close",function(){V(e)}),void 0;pe.hideTopbar();var n=t("#"+e),i=pe.viewport;o.transform(i[0],"translateX","0px"),i.addClass("moving"),pe.changeView(n),pe.cardMask.css("opacity","0.8").addClass("moving");var r=o("card:moving").clear().play();r.actor(pe.cardMask[0],{opacity:"0"},400,"ease"),r.actor(i[0],{transform:"translateX("+$.innerWidth+"px)"},450,"ease"),r.follow().then(function(){if(pe.cardMask.removeClass("moving"),i.hide().removeClass("moving"),o.transform(i[0],"translateX","0px"),e===oe){(R(K.referrer)||!/#.+/.test(K.referrer))&&(pe._backFromSameUrl=!0),Z.back();var t=J.href;setTimeout(function(){J.href===t&&J.reload()},700)}else pe.enableControl(),pe._sessionLocked=!1,pe.showTopbar()})}function P(t){y.BROWSER_CONTROL&&($.location=J.href.replace(/#(.*)|$/,"#$1"+ie+t))}function U(t){pe._preventNextHashEv=!0,J.replace(J.href.replace(/#.*/,"")+(t||re))}function F(){if(!y.WINDOW_SCROLL){var t,e=pe.viewport[0];1>e.scrollTop?e.scrollTop=1:e.scrollTop>(t=e.scrollHeight-e.offsetHeight-1)&&(e.scrollTop=t)}}function W(t,e){if(e=e||{target:"_self"},"_self"!==e.target)q(t,e.target);else{if(pe.disableControl(),m.isOpened)return pe.closeModal().done(function(){W(t,e)}),void 0;pe._sessionLocked=!0,pe.hideTopbar();var n=pe.loadingCard,i=pe.viewport;P(oe),n.addClass("moving"),pe.changeView(n),setTimeout(function(){i.hide(),n.removeClass("moving"),pe._unexpectStateWhenGoback=!1,pe._pageCached=!0,$.location=t},10)}}function q(e,n){y.NEW_WIN?$.open(e,n):t('<a href="'+e+'" target="'+n+'"></a>').trigger("click")}function B(e){var n=e&&e.prev()[0];return n&&!n.offsetHeight?B(t(n)):n}function Y(e){for(var n in e)t.Event.aliases[n]=ne[n]="ck_"+e[n]}function X(){}function z(){return!1}var G,Q,$=this,Z=$.history,J=$.location,K=$.document,te=K.body,ee=0,ne={},ie="!/",re="#"+ie+"i",ae="ckDefault",oe="ckLoading",se="_modal_",ce=10,le=15,ue='<div class="ck-navdrawer"></div>',he='<div class="ck-viewmask"></div>',de='<div class="ck-cardmask"></div>';e.mix(s.Class.prototype,{bind:function(e,n,i){return t(i||this.node).bind(e,n),this},unbind:function(e,n,i){return t(i||this.node).unbind(e,n),this},trigger:function(e,n){return t(e.target).trigger(n),this}});var fe={a:N,"a *":N,".ck-post-link":T,".ck-post-button, .ck-post-button span":S,".ck-switch, .ck-switch span":E,".ck-segment .ck-option, .ck-segment .ck-option span":function(){var e=t(this);e.hasClass("ck-option")||(e=e.closest(".ck-option"));var n=f(e.parent());n.select(e)},".ck-tagselector .ck-option":function(){var t=f(this.parentNode);t.select(this)},".ck-actions .ck-option":function(){var e=t(this).closest(".ck-actions"),n=f(e,{ignoreStatus:"false"!==e.data("ignoreStatus")&&!0});n.select(this)},".ck-folder header":function(){d(this.parentNode).toggle()},".ck-select, .ck-select span, .ck-select .enabled":function(){var e=t(this);e.hasClass("ck-select")||(e=e.parent());var n=f(e);L(e),b.bind("actionView:confirmOnThis",function(t){n.select(t.val())})},".ck-actions-button, .ck-actions-button span":function(){var e=t(this);e.hasClass("ck-actions-button")||(e=e.parent()),L(e)},".ck-modal-button":x,".ck-modal-link":x,".ck-growl-button":function(){g(this).open()},".ck-actionview article > .ck-option":function(){v.current.select(this)},".ck-actionview > footer .confirm":function(){v.current.confirm()},".ck-actionview > footer .cancel":function(){v.current.cancel()},".ck-modalview .wrapper > header .confirm":function(){m.confirm()},".ck-modalview .wrapper > header .cancel":function(){m.cancel()},".ck-ctl-backward":function(){pe.viewport[0].id===ae?V(oe):V(pe.viewport.data("prevCard")||ae)},".ck-ctl-reload":function(){$.location.reload()},".ck-top-overflow":function(){var e=t(".ck-top-overflow-items .ck-item").map(function(e,n){return t(i.convertTpl(this,{i:n,text:t(e).html()},"item"))[0]},_.template);v(this,{options:e}).open(),b.bind("actionView:confirmOnThis",function(e){var n=e.val();b.once("actionView:close",function(){t(".ck-top-overflow-items .ck-item").eq(n).trigger("tap")})})},".ck-top-nav, .ck-top-nav a":function(){this.href||pe.openNavDrawer()}};b.bind("cardkit:updateSize",function(){if(m.isOpened){var t=m._contentWrapper,e=2*$.innerHeight;m._iframeContent&&m._iframeContent.css({minHeight:e+"px",width:t[0].offsetWidth+"px",height:t[0].offsetHeight-pe.headerHeight+"px"}),m._content.css("minHeight",e+"px")}var n=v.current;if(n){var i=$.innerHeight+10,e=n._wrapperContent.children().map(function(t){return t.offsetHeight||0}).reduce(function(t,e){return t+e})+parseFloat(n._wrapperContent.find("article").eq(0).css("bottom"));i>e&&(e=i),n._wrapperContent.css({minHeight:e+"px"}),n._node.css({height:e+"px"})}}),m.event.bind("prepareOpen",function(){pe.disableView=!0,y.CARD_SCROLL?t(te).addClass("bg").addClass("modal-view"):pe.resetWindowTop()}).bind("cancelOpen",function(){pe.disableView=!1,t(te).removeClass("bg").removeClass("modal-view")}).bind("open",function(){y.CARD_SCROLL||t(te).addClass("bg").addClass("modal-view");var e=m._contentWrapper;G=pe.viewport,pe.changeView(e,{isModal:!0}),m._iframeContent?m.event.done("frameOnload",function(){var e=t(m._iframeWindow[0].document.body);e.bind("touchstart",F),pe.initView(e,{isModal:!0}),setTimeout(function(){pe.enableControl()},400)}):m._content.html()?setTimeout(function(){pe.enableControl()},400):m.event.done("contentchange",function(){pe.initView(e,{isModal:!0}),setTimeout(function(){pe.enableControl()},400)})}).bind("prepareClose",function(){pe.disableView=!1,t(te).removeClass("modal-view")}).bind("cancelClose",function(){pe.disableView=!0,t(te).addClass("modal-view")}).bind("close",function(){pe.changeView(G,{preventRender:pe._navDrawerLastView,isModal:pe._navDrawerLastView,isNotPrev:!0}),t(te).removeClass("bg")}),b.bind("actionView:prepareOpen",function(e){pe.disableView=!0;var n=e._wrapper;Q=pe.viewport,n[0].scrollTop=0,pe.changeView(n,{preventRender:!0,preventScroll:!0,isActions:!0}),y.CARD_SCROLL||t(te).addClass("bg")}).bind("actionView:cancelOpen",function(){m.isOpened||(pe.disableView=!1),y.CARD_SCROLL||t(te).removeClass("bg"),pe.changeView(Q,{isNotPrev:!0,preventRender:m.isOpened||pe._navDrawerLastView,preventScroll:!0,isModal:m.isOpened||pe._navDrawerLastView})}).bind("actionView:close",function(){m.isOpened||(pe.disableView=!1),y.CARD_SCROLL||t(te).removeClass("bg"),pe.changeView(Q,{isNotPrev:!0,preventRender:m.isOpened||pe._navDrawerLastView,preventScroll:!0,isModal:m.isOpened||pe._navDrawerLastView})}).bind("actionView:jump",function(t,e,n){t.event.once("close",function(){pe.openURL(e,{target:n})})});var pe={init:function(e){var i=t(K),s=this.root=e.root;this.mainview=t(".ck-main",s),this.wrapper=t(".ck-wrapper",s),this.header=t(".ck-header",s),y.BROWSER_CONTROL||(this.ctlbar=t(k.template).appendTo(this.wrapper),t(te).addClass("has_ctlbar")),this.footer=t(".ck-footer",s),this.raw=t(".ck-raw",s),this.loadingCard=t("#"+oe).data("rendered","1"),this.defaultCard=t("#"+ae),this.scrollMask=t(he).appendTo(te),C.showScrollMask&&this.scrollMask.css({opacity:"0.2",background:"#f00"}),this.controlMask=t(he).appendTo(te),C.showControlMask&&this.controlMask.css({opacity:"0.2",background:"#0f0"}),this.cardMask=t(de).appendTo(this.mainview),this.navDrawer=t(ue).prependTo(s),this.headerHeight=this.header.height(),this.sizeInited=!1,this.viewportGarbage={},this._sessionLocked=!0,this._unexpectStateWhenGoback=!0,this.initWindow(),C.enableConsole&&(console.info("Features:",y),console.info("Platform:",n)),o.config({easing:r}),this.scrollGesture=h(K,{}),Y(this.scrollGesture.event);var u=c(K,{tapThreshold:"android"!==n.os||!n.chrome&&20||0});Y(u.event);var d=l(this.wrapper,{timeThreshold:1e4,distanceThreshold:10});Y(d.event),y.CARD_SCROLL||t(te).addClass("no-cardscroll"),y.SAFARI_OVERFLOWSCROLL||t(te).addClass("no-overflowscroll"),y.HIDE_TOPBAR&&t(te).addClass("mobilesafari-bar"),y.FIXED_BOTTOM_BUGGY&&t(te).addClass("fixed-bottom-buggy"),C.hideToolbars&&t(te).addClass("hide-toolbars"),this.initState(),t($).bind("resize",function(){var t=pe.isLandscape();t!==pe.landscapeMode&&(pe.initWindow(),pe.hideAddressbar(),v.current&&!y.CARD_SCROLL&&(pe.viewport[0].innerHTML=pe.viewport[0].innerHTML))}),this.cardMask.bind("touchstart",function(t){t.preventDefault(),pe.closeNavDrawer()}),this.loadingCard.bind("touchstart",function(t){t.preventDefault()}),a(K,{aliasEvents:ne,matchesSelector:!0,preventDefault:!0}).on("click",{a:H,"a *":H}).on("touchend",{".ck-stars":function(t){A.call(this,t,"val")},".ck-stars .slider-selected":function(t){A.call(this.parentNode,t,"val")}}).on("touchmove",{".ck-stars":function(t){A.call(this,t,"pretend")},".ck-stars .slider-selected":function(t){A.call(this.parentNode,t,"pretend")}}).on("tap",fe),i.bind("scrolldown",function(){g||setTimeout(function(){pe.hideAddressbar()},0)});var f=a(this.wrapper,{aliasEvents:ne,matchesSelector:!0}).on("swipeleft",{".ck-mini-unit .ck-list-wrap *":function(){D.call(this,!0)}}).on("swiperight",{".ck-mini-unit .ck-list-wrap *":function(){D.call(this,!1)}});if(y.SAFARI_OVERFLOWSCROLL||f.on("touchend",{".ck-mini-unit .ck-list-wrap *":function(t){t.preventDefault()}}),y.CARD_SCROLL&&y.SAFARI_OVERFLOWSCROLL&&(i.bind("scrollstart",function(){pe.scrollMask.show()}).bind("scrollend",function(){pe.scrollMask.hide()}),i.bind("touchstart",F)),y.CARD_SCROLL&&i.bind("scroll",function(){if(m.isOpened){var t=$.scrollY;if(!t&&$.innerHeight>=pe.windowFullHeight)return;pe.resetWindowTop(),te.scrollTop=0,t>40&&(pe.viewport[0].scrollTop=pe.viewport[0].scrollTop+t-40)}}),y.CARD_SCROLL){var p,g,_=function(){g=!1},b=function(t){this===t.target&&(p=t.touches[0].clientY,setTimeout(function(){g=!0,pe.viewport[0].scrollTop=0},0))};this.header.find(".ck-top-title").bind("touchstart",b),this.header.bind("touchstart",b),y.HIDE_TOPBAR&&this.header.bind("touchmove",function(t){g&&p>t.touches[0].clientY&&(_(),g=!0,pe.windowFullHeight=1/0,pe.hideAddressbar())}).bind("touchend",_).bind("touchcancel",_)}},showView:function(){t(te).addClass("ck-inited"),pe.hideAddressbar(),pe.hideLoadingCard(),pe.enableControl(),b.resolve("inited")},initWindow:function(){this.landscapeMode=this.isLandscape(),this.windowFullHeight=1/0},initStateWatcher:function(){var e,n;t($).bind("hashchange",function(i){if(!pe._backFromSameUrl){if(e=!0,pe._preventNextHashEv||i.newURL.length>=i.oldURL.length)return pe._preventNextHashEv=!1,void 0;if(pe._sessionLocked)return $.location.reload(!0),void 0;if(n)return pe.resetWindowTop(),P(n),m.isOpened?m.close():pe._backFromOtherpage?(pe._backFromOtherpage=!1,pe.changeView(n),pe._sessionLocked=!1,pe.showView()):V(n),n=!1,void 0;var r=J.hash.split(ie).pop();if(r&&"i"!==r){if(pe._sessionLocked=!1,n=r===se&&ae||r,!t("#"+n).hasClass("ck-card"))return $.location.reload(!0),void 0;Z.back()}else V(oe)}}),t($).bind("popstate",function(){if(pe._backFromSameUrl){var t=$.location.hash.split(ie).pop();return t?(Z.back(),void 0):($.location.reload(),void 0)}e=!1,setTimeout(function(){e||pe._backFromOtherpage||(pe._sessionLocked=!1,pe._backFromOtherpage=!0,y.GOBACK_WHEN_POP&&!pe._unexpectStateWhenGoback?Z.back():$.location.reload(!0))},100)})},initState:function(){pe._sessionLocked=!1,y.BROWSER_CONTROL?pe.initStateWatcher():b.once("inited",function(){var e=y.NO_POP_ON_CACHED_PAGE?"resize":"popstate";t($).bind(e,function(){(!y.RESIZE_WHEN_SCROLL||pe._pageCached)&&(pe._pageCached=!1,pe.hideTopbar(),pe.viewport.hide(),pe.changeView(pe.loadingCard),setTimeout(function(){$.location.reload()},20))})});var e,n,i=J.hash.replace(/^#/,"");if(i&&(i=i.split(ie)),i){var r=[];if(i=i.map(function(e){return e===se||"i"===e||e&&t("#"+e).hasClass("ck-card")?(r.push(ie+e),e):void 0}).filter(function(t){return t}),e=i.pop(),r=r.join(""),"#"+r!==J.hash&&(U(re+r),!y.REPLACE_HASH))return $.location.reload();y.BROWSER_CONTROL||(e===oe||e===se)&&(e=null),e===se?(n=!0,e=ae):"i"===e&&(e=null)}y.BROWSER_CONTROL&&y.REPLACE_HASH&&!R(K.referrer)&&(U(re),e&&(i.forEach(function(t){"i"!==t&&P(t)}),P(e))),e?(pe.changeView(e),e===oe||n?(pe._backFromOtherpage=!0,Z.back()):pe.showView()):pe.initNewPage()},initNewPage:function(){pe.changeView(pe.defaultCard),P(ae),pe.showView()},initView:function(t,e){w.openCard(t,e),t.data("rendered")||e.preventRender||(w.initCard(t,this.raw,this.footer,e),e.isModal||e.isActions||t.data("rendered","1")),this.watchScroll(t)},releaseView:function(t){this.viewport&&w.closeCard(this.viewport,t)},changeView:function(e,n){n=n||{},y.CARD_SCROLL||n.preventScroll||pe.resetWindowTop(),this.releaseView(n),"string"==typeof e&&(e=t("#"+e));var i=e===this.loadingCard;this.viewport&&!n.isNotPrev&&e.data("prevCard",this.viewport[0].id),this.initView(e,n),this.viewport=e.show(),this.updateSize(n),n.isModal||n.isActions||this.updateFrame(),i||setTimeout(function(){b.fire("readycardchange",[e])},0)},updateSize:function(e){if(e=e||{},(y.CARD_SCROLL||e.isActions)&&this.viewport[0].id!==oe){this.viewport[0].style.height=(this.sizeInited?$.innerHeight:screen.availHeight+60)+2+"px";var n=this.viewport.find(".ck-footer"),i=B(n);if(i){var r=screen.availHeight-(i.offsetTop+i.offsetHeight+this.viewport[0].scrollTop);r>0?n.css("paddingTop",r+"px"):n.css("paddingTop","0px")}}this.viewport.find(".ck-mini-unit").forEach(function(t){var e=this(".ck-item",t),n=pe.slideItemWidth=$.innerWidth-ce-le;e.length>1&&(e.css("width",n-ce-2+"px"),this(".ck-list",t).css("width",n*e.length+ce+"px"))},t),b.fire("cardkit:updateSize")},watchScroll:function(t){this.scrollGesture.watchScroll(t[0])},updateFrame:function(){w.setFrame(this.viewport,this.header,this.navDrawer,this.raw)},renderUnit:function(t){w.initUnit(t,this.raw)},hideLoadingCard:function(){pe.loadingCard.hide().css({height:$.innerHeight+60+"px",position:"static"}),pe.showTopbar()},hideTopbar:function(){this.topbarEnable&&!this.disableView&&(this.topbarEnable=!1,t(te).removeClass("ck-topbar-enabled"))},showTopbar:function(){this.topbarEnable||(this.topbarEnable=!0,t(te).addClass("ck-topbar-enabled"))},hideAddressbar:function(){this.windowFullHeight>$.innerHeight&&(this.loadingCard.find("div")[0].style.visibility="hidden",!y.HIDE_TOPBAR||!y.CARD_SCROLL&&this.sizeInited||(pe.resetWindowTop(),te.scrollTop=0),this.sizeInited||(this.sizeInited=!0),this.windowFullHeight=$.innerHeight,pe.updateSize(),this.loadingCard.find("div")[0].style.visibility="")},resetWindowTop:function(){y.HIDE_ADDRESSBAR&&$.scrollTo(0,-1)},isLandscape:function(){return $.innerWidth/$.innerHeight>1.1},enableControl:function(){this.controlMask.hide(),$.ckControl=X},disableControl:function(){this.controlMask.show(),$.ckControl=z},showLoading:function(t){this.disableControl(),this.loadingTips||(this.loadingTips=g({expires:-1,keepalive:!0,corner:"center"})),this.loadingTips.set({content:t||"正在加载..."}).open(),this._loadingStart=+new Date},hideLoading:function(t){t=e.mix({duration:800},t);var n=+new Date-this._loadingStart;t.duration>n?setTimeout(function(){pe.hideLoading(t)},t.duration-n):(this.loadingTips&&this.loadingTips.close(),this.enableControl())},openNavDrawer:function(){pe._navDrawerLastView||(pe._navDrawerLastView=pe.viewport,pe.navDrawer.show(),pe.changeView(pe.navDrawer.find("article"),{preventRender:!0,isNotPrev:!0,isModal:!0}),t(te).addClass("nav-view"))},closeNavDrawer:function(){return pe._navDrawerLastView?(pe.changeView(pe._navDrawerLastView,{isNotPrev:!0}),t(te).removeClass("nav-view"),setTimeout(function(){pe._navDrawerLastView=!1,pe.navDrawer.hide(),setTimeout(function(){b.fire("navdrawer:close")},50)},400),b.promise("navdrawer:close")):void 0},openModal:function(t){this.hideAddressbar(),this.disableControl(),m.isOpened||P(se),m.set(t).open()},closeModal:function(){return m.cancel(),m.event.promise("close")},alert:function(t,n){v("ckAlert",e.mix({title:"提示",content:t||"",cancelText:"关闭",multiselect:!1},n)).open()},confirm:function(t,n,i){v("ckAlert",e.mix({title:"提示",content:t||"",confirmText:"确认",cancelText:"取消",multiselect:!0},i)).open().event.once("confirm",n)},notify:function(t,n){pe.growl(e.mix({content:t},n)).open()},openURL:W,delegate:a(K,{aliasEvents:ne,autoOverride:!0,matchesSelector:!0,preventDefault:!0}),event:b,control:d,picker:f,modalCard:m,actionView:v,growl:g};return pe}),require.config({baseUrl:"js/mod/",distUrl:"dist/js/mod/",aliases:{cardkit:"../cardkit/"}}),define("mo/easing/functions",[],function(){}),define("mo/mainloop",[],function(){}),define("cardkit/env",["mo/browsers"],function(){return{}}),define("cardkit/pageready",["finish","cardkit/bus"],function(t,e){e.once("readycardchange",function(){setTimeout(t,500)})}),require(["dollar","cardkit/bus","cardkit/app","cardkit/env"],function(t,e,n,i){function r(){n.init({root:t(".ck-root")})}i.enableConsole?require(["mo/console"],function(t){t.config({record:!0}).enable(),r()}):r()});